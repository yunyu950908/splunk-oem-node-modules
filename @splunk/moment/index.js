...
var _splunkFormat = __webpack_require__(121);

var _splunkFormat2 = _interopRequireDefault(_splunkFormat);

var _splunkTimezone = __webpack_require__(123);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_moment2.default.newSplunkTime = _splunkTimezone.newSplunkTime;
_moment2.default.addSplunkTimezone = _splunkTimezone.addSplunkTimezone;
_moment2.default.setDefaultSplunkTimezone = _splunkTimezone.setDefaultSplunkTimezone;
_moment2.default.getDefaultSplunkTimezone = _splunkTimezone.getDefaultSplunkTimezone;
_moment2.default.fn.splunkFormat = _splunkFormat2.default;
...
exports.default = splunkFormat;

var _formats = __webpack_require__(122);
 ...
 * seconds and milliseconds. Other formats are passed through to moment().format();
 * ```
 ...
 * ```
 *
 * Only the Splunk server locale's are supported:
 * ```
 ...
 * @public
 */
function splunkFormat(format) {
    var _this = this;

    var supportedFormats = ['LLMS', 'LLS', 'lls', 'ls', 'llms', 'lms', 'LTMS'];
    var locale = this.locale();
    var localeFormats = _formats2.default[locale];

    var s = format || '';

    if (!localeFormats) {
        throw new Error('moment().splunkFormat() does not support the locale ' + locale);
    }

    // Any of these formats may appear with other tokens or strings.
    supportedFormats.some(function (f) {
        var pos = format.indexOf(f);

        if (pos > -1) {
            var localizedString = _this.format(localeFormats[f]);

            s = s.substring(0, pos) + '[' + localizedString + ']' + s.substring(pos + f.length);
...
exports.default = {
    de: {
        LTMS: 'HH:mm:ss,SSS',
        ls: 'D.M.YYYY HH:mm:ss',
        lms: 'D.M.YYYY HH:mm:ss,SSS',
        lls: 'D. MMM YYYY HH:mm:ss',
        llms: 'D. MMM YYYY HH:mm:ss,SSS',
        LLS: 'D. MMMM YYYY HH:mm:ss',
        LLMS: 'D. MMMM YYYY HH:mm:ss,SSS'
    },
    'en-gb': {
        LTMS: 'HH:mm:ss.SSS',
        ls: 'D/M/YYYY HH:mm:ss',
    ...
    en: {
        LTMS: 'h:mm:ss.SSS A',
        ls: 'M/D/YYYY h:mm:ss A',
        lms: 'M/D/YYYY h:mm:ss.SSS A',
        lls: 'MMM D, YYYY h:mm:ss A',
        llms: 'MMM D, YYYY h:mm:ss.SSS A',
        LLS: 'MMMM D, YYYY h:mm:ss A',
        LLMS: 'MMMM D, YYYY h:mm:ss.SSS A'
    },
    fr: {
        LTMS: 'HH:mm:ss,SSS',
        ls: 'D/M/YYYY HH:mm:ss',
    ...
    ja: {
        LTMS: 'HH:mm:ss.SSS',
        ls: 'YYYY/MM/DD HH:mm:ss',
        lms: 'YYYY/MM/DD HH:mm:ss.SSS',
        lls: 'YYYY年M月D日 HH:mm:ss',
        llms: 'YYYY年M月D日 HH:mm:ss.SSS',
        LLS: 'YYYY年M月D日 HH:mm:ss',
        LLMS: 'YYYY年M月D日 HH:mm:ss.SSS'
    },
    ko: {
        LTMS: 'A h:mm:ss.SSS',
        ls: 'YYYY.MM.DD A h:mm:ss',
        lms: 'YYYY.MM.DD A h:mm:ss.SSS',
        lls: 'YYYY년 MMMM D일 A h:mm:ss',
        llms: 'YYYY년 MMMM D일 A h:mm:ss.SSS',
        LLS: 'YYYY년 MMMM D일 A h:mm:ss',
        LLMS: 'YYYY년 MMMM D일 A h:mm:ss.SSS'
    },
    'zh-cn': {
        LTMS: 'HH:mm:ss.SSS',
        ls: 'YYYY年MMMD日 HH:mm:ss',
        lms: 'YYYY年MMMD日 HH:mm:ss.SSS',
        lls: 'YYYY年MMMD日 HH:mm:ss',
        llms: 'YYYY年MMMD日 HH:mm:ss.SSS',
        LLS: 'YYYY年MMMD日Ah点mm分s秒',
        LLMS: 'YYYY年MMMD日 HH:mm:ss.SSS'
    },
    'zh-tw': {
        LTMS: 'HH:mm:ss.SSS',
...
exports.getDefaultSplunkTimezone = exports.setDefaultSplunkTimezone = exports.addTimezone = undefined;
exports.newSplunkTime = newSplunkTime;
...
var _convertSplunkTimezone = __webpack_require__(2);

var _convertSplunkTimezone2 = _interopRequireDefault(_convertSplunkTimezone);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var splunkTimezone = void 0;
/**
 * A shortcut for creating moment instances with the Splunk locale and timezone. Either window.$C
 * must be set on the page, or moment.setDefaultSplunkTimezone() must have been called.
 * ```
 ...
 * ```
 * @param {Object} [options] - An object with `time`, `locale` and/or `format` (for parsing) properties.
 * See above examples.
 * `locale` defaults to the server locale when available. Otherwise defaults to moment's default locale.
 * @returns {Object} A `moment` instance with the locale and timezone set.
 * @memberof moment
 * @name newSplunkTime
 * @function
 * @public
...
function newSplunkTime(options) {
    var _ref = options || {},
        time = _ref.time,
        format = _ref.format;

    var loc = options && options.locale || _config.locale;

    if (!splunkTimezone) {
        throw new Error('The Splunk server timezone data is not available.');
    }
    return _moment2.default.tz(time, format, loc, splunkTimezone);
}

/**
 * Add a timezone using Splunk's Serialized Timezone Format 1.0.
 * @param {string} timezone - A timezone in Splunk's Serialized Timezone Format 1.0.
 * @param {string} [name] - Defaults to a generated guid to avoid name conflicts.
 * @returns {string} The `name` parameter or the generated guid.
 *
 * @memberof moment
 * @name addTimezone
 * @function
 * @public
 */
var addTimezone = exports.addTimezone = (0, _lodash.memoize)(function (zone, name) {
    if (!zone) {
        throw new Error('Serialized Splunk timezone is required when adding or setting time zones.');
    }

    var id = name || (0, _id.createGUID)();
    _moment2.default.tz.add(_moment2.default.tz.pack((0, _convertSplunkTimezone2.default)(zone, id)));
    return id;
});

/**
 * Sets the default timezone for newSplunkTime() and return's the name of the time zone. This function
 * is memoized, so it is safe to call multiple times with the same timezone data.
 *
 * @param {string} timezone - A timezone in Splunk's Serialized Timezone Format 1.0.
 * @returns {string} The name of the server timezone. Since this information is not available,
 * the function generates a guid which is returned as the name, which may be useful for later use
 * with moment-timezone.
 *
 * @memberof moment
 * @name setDefaultSplunkTimezone
 * @function
 * @public
 */
var setDefaultSplunkTimezone = exports.setDefaultSplunkTimezone = (0, _lodash.memoize)(function (zone) {
    splunkTimezone = addTimezone(zone);
    return splunkTimezone;
});
if (_config.serverTimezoneInfo) {
    setDefaultSplunkTimezone(_config.serverTimezoneInfo);
}

/**
 * Get the default timezone name. This may be useful should you need to convert one timezone to another.
 * @returns {string} The name of the server timezone.
 *
 * @memberof moment
 * @name getDefaultSplunkTimezone
 * @function
 * @public
 */
var getDefaultSplunkTimezone = exports.getDefaultSplunkTimezone = function getDefaultSplunkTimezone() {
    return splunkTimezone;
};

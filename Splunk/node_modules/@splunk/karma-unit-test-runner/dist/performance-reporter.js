...
var PerformanceReporter = function PerformanceReporter() {
    ...
    this.onBrowserStart = function (browser) {
        ...
        browser.onInfo = function () {
            ...
            if (_.has(info, 'talos') && info.talos == 'timings') {
                ...
                table.push.apply(table, _(info.timings).flatMap(function (fileDurations, app) {

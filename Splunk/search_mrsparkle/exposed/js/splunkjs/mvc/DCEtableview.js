define(function (require, exports, module) {
    ...
    var TableView = BaseVisualizationView.extend(/** @lends splunkjs.mvc.TableView.prototype */{
        ...
        className: 'splunk-table dce-oem-table',
        ...
        getDrilldownData: function(e) {
            ...
            // get resultsModel from connection which contains raw data.
            if (this.managerConnection && this.managerConnection.isConnected()) {
                ...
                var originalRows = rawResultsModel ? rawResultsModel.data().rows : null;
                var rowIndex = e.rowIndex;
                if (originalRows && (rowIndex < originalRows.length)) {
                    var originalRow = originalRows[rowIndex];
                    _(rawResultsModel.data().fields).each(function(originalField, i) {
        ...
        onDrilldown: function(e, payload) {
            ...
            // get resultsModel from connection which contains raw data.
            var rawResultsModel = this.managerConnection.resultsModel;
            var model = rawResultsModel.collection().at(e.rowIndex);
            if (model) {
        ...
        onFieldsChanged: function(){
            this.transformFieldsToArray();
            if (this.managerConnection && this.managerConnection.isConnected()) {
                // reformat the raw data by manually calling onDataChange.

define(function(require, exports, module) {
    ...
    var EditInputMenuView = PopTartView.extend({
        ...
        toggleEditType: function(type) {
            ...
            if (type === 'time') {
                if (this.previousDefault) {
                    this.workingSettings.set('default', this.previousDefault);
                    this.previousDefault = null;
                }
            } else if (fromType === 'time' && this.workingSettings.get('default')) {
                this.previousDefault = this.workingSettings.get('default');
                // clear default and initialValue properties when you are not in time input

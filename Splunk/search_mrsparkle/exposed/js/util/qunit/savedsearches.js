        ...
        return {
            ...
            createSavedsearchesController: function(product){
                ...
                return new PageController({
                    ...
                    collection: this.router.collection
                });
            },
            ...
            testControllerSetup: function(view) {
                ...
                assert.equal(Object.keys(view.collection).length, 14, "There should be 14 items in the collection.");
                assert.equal(Object.keys(view.collection)[0], "appLocals", "This item in the collection should be appLocals.");
                assert.equal(Object.keys(view.collection)[1], "appLocalsUnfiltered", "This item in the collection should be appLocalsUnfiltered.");
                assert.equal(Object.keys(view.collection)[2], "appLocalsUnfilteredAll", "This item in the collection should be appLocalsUnfilteredAll.");
                assert.equal(Object.keys(view.collection)[3], "managers", "This item in the collection should be managers.");
                assert.equal(Object.keys(view.collection)[4], "tours", "This item in the collection should be tours.");
                assert.equal(Object.keys(view.collection)[5], "visualizations", "This item in the collection should be visualizations.");
                assert.equal(Object.keys(view.collection)[6], "users", "This item in the collection should be users.");
                assert.equal(Object.keys(view.collection)[7], "alertActions", "This item in the collection should be alertActions.");
                assert.equal(Object.keys(view.collection)[8], "searchBNFs", "This item in the collection should be searchBNFs.");
                assert.equal(Object.keys(view.collection)[9], "indexes", "This item in the collection should be indexes.");
                assert.equal(Object.keys(view.collection)[10], "rolesCollection", "This item in the collection should be rolesCollection.");
                assert.equal(Object.keys(view.collection)[11], "usersSearch", "This item in the collection should be usersSearch.");
                assert.equal(Object.keys(view.collection)[12], "flashMessages", "This item in the collection should be flashMessages.");
                assert.equal(Object.keys(view.collection)[13], "entities", "This item in the collection should be entities.");

                assert.equal(Object.keys(view.deferreds).length, 7, "There should be 7 items in deferreds.");

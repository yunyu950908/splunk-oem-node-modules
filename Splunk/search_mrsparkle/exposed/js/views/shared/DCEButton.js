    ...
    return BaseView.extend({
        ...
        render: function() {
            ...
            if (this.options.menu) {
                // DCE-OEM-CHANGE 将 切换应用的 icon caret 换成svg down-arrow
                this.children.caret = this.children.caret || new Icon({svg: this.options.svg, icon: 'caret'});
            ...
            if (this.options.icon) {
                ...
                // DCE-OEM-CHANGE 将 切换应用的 icon caret 换成svg down-arrow
                this.children.icon.set({svg: this.options.svg, icon: this.options.icon, size: this.options.iconSize});

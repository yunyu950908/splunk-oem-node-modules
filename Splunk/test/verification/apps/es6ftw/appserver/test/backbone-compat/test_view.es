import ES6ViewSuperclass from 'es6ftw/backbone/ES6ViewSuperclass';
import ES6ToES5ViewSubclass from 'es6ftw/backbone/ES6ToES5ViewSubclass';
import ES6ToES6ViewSubclass from 'es6ftw/backbone/ES6ToES6ViewSubclass';
...
suite('ES6 View subclassing BaseView', function () {
    ...
    test('Module ID is correct', function () {
        assert.equal(this.view.moduleId, 'es6ftw-backbone/ES6ViewSuperclass');
    });
});

...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./ButtonGroup.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./ButtonGroup.css");
...
/* WEBPACK VAR INJECTION */(function(module) {var styles = {"lite":".main_ButtonGroup__guid__56ff0b{position:relative}.main_ButtonGroup__guid__56ff0b+.main_ButtonGroup__guid__56ff0b{margin-left:10px}","enterprise":".main_ButtonGroup__guid__56ff0b{position:relative}.main_ButtonGroup__guid__56ff0b+.main_ButtonGroup__guid__56ff0b{margin-left:10px}"};
var themeLocals = {"lite":{"main":"main_ButtonGroup__guid__56ff0b"},"enterprise":{"main":"main_ButtonGroup__guid__56ff0b"}};
var isLite =
...
function ButtonGroup(props) {
    ...
    var childrenCleaned = _react.Children.toArray(children).filter(_react.isValidElement).map(function (item, i, _ref) {
        ...
        return (0, _react.cloneElement)(item, {
            ...
            key: item.key || i,
            inline: false,
            style: (0, _lodash.extend)({ width: 'auto' }, item.style)
        });
    });
    ...
    return _react2.default.createElement(
        ...
        _extends({
            flex: true,
            className: (0, _toClassName2.default)(_ButtonGroup2.default.main, className)
...
/* WEBPACK VAR INJECTION */}.call(exports, "src/components/ButtonGroup/ButtonGroup.jsx"))

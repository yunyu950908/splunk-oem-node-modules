...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./Clickable.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./Clickable.css");
...
module.exports = require("splunk-ui/icons/External");
...
var _External = __webpack_require__(273);
...
var _Clickable = __webpack_require__(177);
...
var Clickable = function (_Component) {
    ...
    function Clickable(props) {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = Clickable.__proto__ || Object.getPrototypeOf(Clickable)).call.apply(_ref, [this, props].concat(rest)));
        ...
        if (process.env.NODE_ENV !== "production" && (0, _lodash.has)(props, 'href')) {
            (0, _errorHandling.invariant)('Use Clickable\'s "to" prop instead of "href".');
        }
        return _this;
    }
    ...
    _createClass(Clickable, [{
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                contentWrapperClassName = _props.contentWrapperClassName,
                to = _props.to,
                openInNewContext = _props.openInNewContext,
                newContextIconClassName = _props.newContextIconClassName,
                children = _props.children,
                screenReaderContent = _props.screenReaderContent,
                otherProps = _objectWithoutProperties(_props, ['className', 'contentWrapperClassName', 'to', 'openInNewContext', 'newContextIconClassName', 'children', 'screenReaderContent']);
            ...
            var externalIcon = openInNewContext && _react2.default.createElement(
                'span',
                { className: newContextIconClassName },
                _react2.default.createElement(_External2.default, { size: 0.8, style: { verticalAlign: 'baseline' } })
            );
            return _react2.default.createElement(
                Tag,
                _extends({
                    className: (0, _toClassName2.default)(_Clickable2.default.main, className),
                    ref: function ref(el) {
                        return _this2.el = el;
                    },
                    onClick: this.handleOnClick
                }, (0, _testSupport.createTestHook)(__filename), (0, _lodash.omit)(otherProps, 'onClick')),
                contentWrapperClassName && _react2.default.createElement(
                    'span',
                ...
                screenReaderContent && _react2.default.createElement(
...
Clickable.propTypes = {
    ...
    */
    contentWrapperClassName: _propTypes2.default.string,
    /** Add a disabled attribute and prevent clicking. */
    disabled: _propTypes2.default.bool,
    /** A class to set on the icon wrapper.  */
    newContextIconClassName: _propTypes2.default.string,
    ...
    */
    ...
    screenReaderContent: _propTypes2.default.node,
    /**
...
Clickable.defaultProps = {
    disabled: false,
    newContextIconClassName: _Clickable2.default.newContext
};
exports.default = Clickable;
/* WEBPACK VAR INJECTION */}.call(exports, "src/components/Clickable/Clickable.jsx"))

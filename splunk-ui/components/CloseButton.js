...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./CloseButton.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./CloseButton.css");
...
module.exports = require("splunk-ui/icons/Close");
...
var _Close = __webpack_require__(270);

var _Close2 = _interopRequireDefault(_Close);

var _CloseButton = __webpack_require__(178);
...
var defaultProps = {
    screenReaderText: (0, _i18n._)('Close')
};

function CloseButton(props) {
    var className = props.className,
        screenReaderText = props.screenReaderText,
        other = _objectWithoutProperties(props, ['className', 'screenReaderText']);

    return _react2.default.createElement(
        'button',
        _extends({
            className: (0, _toClassName2.default)(_CloseButton2.default.main, className)
        }, (0, _testSupport.createTestHook)(__filename), other),
        _react2.default.createElement(_Close2.default, { inline: false, screenReaderText: screenReaderText })
    );
}

CloseButton.propTypes = propTypes;
CloseButton.defaultProps = defaultProps;
/* WEBPACK VAR INJECTION */}.call(exports, "src/components/CloseButton/CloseButton.jsx"))

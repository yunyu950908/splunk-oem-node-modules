...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./ModalLayer.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./ModalLayer.css");
...
var _ModalLayer = __webpack_require__(198);
...
var ModalLayer = function (_Component) {
    ...
    function ModalLayer(props) {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = ModalLayer.__proto__ || Object.getPrototypeOf(ModalLayer)).call.apply(_ref, [this, props].concat(rest)));

        _this.handleClickAway = function (event) {
            _this.props.onRequestClose({ reason: 'clickAway', event: event });
        };
        ...
        _this.renderLayer = function () {
            ...
            var open = _this.props.open || _this.state.animating;
            return _react2.default.createElement(
                _reactMotion.Motion,
                {
                    defaultStyle: _extends({}, getDefaultMotionStyle(), {
                        overlayOpacity: 0
                    }),
                    style: _extends({}, getMotionStyle(), {
                        overlayOpacity: (0, _reactMotion.spring)(_this.props.open ? 1 : 0, { precision: 1 })
                    }),
                ...
                function (intepolatedStyle) {
                    return _react2.default.createElement(
                        'div',
                        null,
                        renderModal((0, _lodash.omit)(intepolatedStyle, 'overlayOpacity')),
                        open && useLayerForClickAway && _react2.default.createElement('div', {
                            className: _ModalLayer2.default.overlay,
                            onClick: _this.handleClickAway,

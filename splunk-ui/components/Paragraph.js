...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./Paragraph.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./Paragraph.css");
...
var _Paragraph = __webpack_require__(200);
...
function Paragraph(props) {
    ...
    return _react2.default.createElement(
        'p',
        _extends({
            className: (0, _toClassName2.default)(_Paragraph2.default.main, className)
        }, otherProps),
        children
    );
}

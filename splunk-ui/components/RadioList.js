...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./RadioList.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./RadioList.css");
...
var _Switch = __webpack_require__(828);
...
function Option(props) {
  var children = props.children,
      switchProps = _objectWithoutProperties(props, ['children']);

  return _react2.default.createElement(
    _Switch2.default,
    _extends({ appearance: 'radio' }, switchProps),
    children
  );
}
...
/* WEBPACK VAR INJECTION */(function(module) {var styles = {"enterprise":".main_RadioList__guid__e7e3e3{-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;flex-direction:column;-webkit-box-align:start;-webkit-align-items:flex-start;align-items:flex-start}","lite":".main_RadioList__guid__e7e3e3{-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;flex-direction:column;-webkit-box-align:start;-webkit-align-items:flex-start;align-items:flex-start}"};
var themeLocals = {"enterprise":{"main":"main_RadioList__guid__e7e3e3"},"lite":{"main":"main_RadioList__guid__e7e3e3"}};
var isLite =
...
var _RadioList = __webpack_require__(203);
...
var RadioList = function (_Component) {
    ...
    function RadioList(props) {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = RadioList.__proto__ || Object.getPrototypeOf(RadioList)).call.apply(_ref, [this, props].concat(rest)));
        ...
        if (process.env.NODE_ENV !== "production" && _this.isControlled() && (0, _lodash.has)(props, 'defaultValue')) {
            (0, _errorHandling.invariant)('RadioList defaultValue prop is not compatible with value prop.');
        }

        if (process.env.NODE_ENV !== "production" && _this.isControlled() && props.onChange === noop) {
            (0, _errorHandling.invariant)('RadioList onChange prop is required. This must update the value prop\n                to retain user input.');
        }
        return _this;
    }
    ...
    _createClass(RadioList, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            if (process.env.NODE_ENV !== "production" && !this.isControlled() && (0, _lodash.has)(nextProps, 'value')) {
                (0, _errorHandling.invariant)('Cannot change RadioList from an uncontrolled component to a controlled\n    one. Prop \'value\' is not valid in subsequent updates if not provided in the initial props.');
            }

            if (process.env.NODE_ENV !== "production" && nextProps.defaultValue !== this.props.defaultValue) {
                (0, _errorHandling.invariant)('Cannot change RadioList defaultValue after set.');
            }
        }
    }, {
        key: 'isControlled',
        ...
        value: function render() {
            ...
            var _props = this.props,
                ...
                size = _props.size,
                value = _props.value,
                otherProps = _objectWithoutProperties(_props, ['children', 'className', 'describedBy', 'disabled', 'labelledBy', 'size', 'value']);

            var selectedValue = this.isControlled() ? value : this.state.value;

            var clonedChildren = _react.Children.toArray(children).filter(_react.isValidElement).map(function (option, i) {
            ...
            return _react2.default.createElement(
                ...
                _extends({
                    flex: true,
                    className: (0, _toClassName2.default)(_RadioList2.default.main, className),
                    role: 'radiogroup',
...
RadioList.Option = _Option2.default;
exports.default = RadioList;
/* WEBPACK VAR INJECTION */}.call(exports, "src/components/RadioList/RadioList.jsx"))
...
module.exports = require("splunk-ui/components/Switch");

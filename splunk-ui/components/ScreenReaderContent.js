...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./ScreenReaderContent.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./ScreenReaderContent.css");
...
/* WEBPACK VAR INJECTION */(function(module) {var styles = {"lite":".main_ScreenReaderContent__guid__2c4e08{position:absolute;overflow:hidden;clip:rect(0 0 0 0);height:1px;width:1px;margin:-1px;padding:0;border:0}","enterprise":".main_ScreenReaderContent__guid__2c4e08{position:absolute;overflow:hidden;clip:rect(0 0 0 0);height:1px;width:1px;margin:-1px;padding:0;border:0}"};
var themeLocals = {"lite":{"main":"main_ScreenReaderContent__guid__2c4e08"},"enterprise":{"main":"main_ScreenReaderContent__guid__2c4e08"}};
var isLite =
...
var _ScreenReaderContent = __webpack_require__(205);
...
*/
function ScreenReaderContent(props) {
    ...
    return _react2.default.createElement(
        'span',
        _extends({
            className: (0, _toClassName2.default)(_ScreenReaderContent2.default.main, className)
...
/* WEBPACK VAR INJECTION */}.call(exports, "src/components/ScreenReaderContent/ScreenReaderContent.jsx"))

...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./StaticContent.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./StaticContent.css");
...
var _StaticContent = __webpack_require__(210);
...
function StaticContent(props) {
    var children = props.children,
        ...
        size = props.size,
        otherProps = _objectWithoutProperties(props, ['children', 'className', 'size']);

    return _react2.default.createElement(
        _Box2.default,
        _extends({
            className: (0, _toClassName2.default)(_StaticContent2.default.main, className),
            'data-size': size
        }, (0, _testSupport.createTestHook)(__filename, props), otherProps),
        children
    );
}
...
/* WEBPACK VAR INJECTION */}.call(exports, "src/components/StaticContent/StaticContent.jsx"))

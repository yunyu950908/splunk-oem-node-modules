...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../../../splunk-postcss-loader/lib/index.js!./TransitionOpen.css", function() {
			var newContent = require("!!./../../../../splunk-postcss-loader/lib/index.js!./TransitionOpen.css");
...
var _TransitionOpen = __webpack_require__(216);
...
var TransitionOpen = function (_Component) {
    ...
    function TransitionOpen(props) {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = TransitionOpen.__proto__ || Object.getPrototypeOf(TransitionOpen)).call.apply(_ref, [this, props].concat(rest)));
        ...
        _this.handleMount = function (el) {
            ...
            if (el) {
                if (_this.props.takeFocus) {
                    (0, _focus.takeFocus)(el, 'container');
                }
        ...
        _this.handleTab = function (e) {
            (0, _focus.handleTab)(_this.state.innerEl, e);
        };

        _this.internalRender = function (_ref2) {
            ...
            var mainClassName = open && !animating ? _TransitionOpen2.default.open : _TransitionOpen2.default.notOpen;
            ...
            return _react2.default.createElement(
                'div',
                _extends({
                    className: (0, _toClassName2.default)(mainClassName, outerClassName)
                }, (0, _testSupport.createTestHook)(__filename), {
                    style: _extends({}, outerStyle, _defineProperty({}, dimension, value))
                }),
                (open || animating) && _react2.default.createElement(
                    'div',
                    _extends({}, (0, _lodash.omit)(_this.props, (0, _lodash.keys)(TransitionOpen.propTypes)), {
                        ref: _this.handleMount,
                        tabIndex: -1,
                        className: (0, _toClassName2.default)(_TransitionOpen2.default.inner, innerClassName),
                        onKeyDown: _this.props.retainFocus ? _this.handleTab : null,
                        style: _extends({}, innerStyle, { transform: transform })
                    }),
                    children
                )
            );
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                _reactMotion.Motion,
                {
                    ...
                    style: { value: (0, _reactMotion.spring)(open ? value : 0, { precision: 1 }) }
                },
                this.internalRender
            );
        }
...
TransitionOpen.propTypes = {
    animation: _propTypes2.default.oneOf(['slideFromTop', 'slideFromRight', 'slideFromBottom', 'slideFromLeft', 'expandHeight', 'expandWidth']),
...
exports.default = TransitionOpen;
/* WEBPACK VAR INJECTION */}.call(exports, "src/components/TransitionOpen/TransitionOpen.jsx"))

...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SlidingPanels = __webpack_require__(506);
	    ...
	    function SlidingPanels() {
	        ...
	        _this.renderOuterContainer = function (interpolatedOuterStyle) {
	            ...
	            _react.Children.forEach(children, function (child) {
	                if (child.props.panelId === activePanelId) {
	                    currentPanel = child;
	                }
	            });
	            var transitionStyle = {
	...
	SlidingPanels.propTypes = {
	    activePanelId: _react.PropTypes.any.isRequired,
	    /** @docs-ignore. */
	    children: _react.PropTypes.node.isRequired,
	    innerClassName: _react.PropTypes.string,
	    innerStyle: _react.PropTypes.object,
	    onAnimationEnd: _react.PropTypes.func,
	    outerClassName: _react.PropTypes.string,
	    outerStyle: _react.PropTypes.object,
	    transition: _react.PropTypes.oneOf(['forward', 'backward'])
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Panel = __webpack_require__(505);
	...
	Panel.propTypes = {
	     ...
	     */
	    panelId: _react.PropTypes.any.isRequired,
	    /**
	     * @docs-ignore.
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../tools/web_loaders/theme-loader/index.js!./Panel.css", function() {
				var newContent = require("!!./../../../tools/web_loaders/theme-loader/index.js!./Panel.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../tools/web_loaders/theme-loader/index.js!./SlidingPanels.css", function() {
				var newContent = require("!!./../../../tools/web_loaders/theme-loader/index.js!./SlidingPanels.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var styles = {"enterprise":".main_SlidingPanels__guid__c90191{overflow:hidden;position:relative}.comingPanel_SlidingPanels__guid__c90191{position:absolute;left:0;top:0}","lite":".main_SlidingPanels__guid__c90191{overflow:hidden;position:relative}.comingPanel_SlidingPanels__guid__c90191{position:absolute;left:0;top:0}"};
	var themeLocals = {"enterprise":{"main":"main_SlidingPanels__guid__c90191","comingPanel":"comingPanel_SlidingPanels__guid__c90191"},"lite":{"main":"main_SlidingPanels__guid__c90191","comingPanel":"comingPanel_SlidingPanels__guid__c90191"}};
	var isLite =
	    window.__splunkd_partials__ &&
	    window.__splunkd_partials__['/services/server/info'] &&
	    window.__splunkd_partials__['/services/server/info']

...
const propTypes = {
    /** @docs-ignore */
    appearance: PropTypes.oneOf(['corporate', 'enterprise', 'light']),
    /** @docs-ignore */
...
function SVG(props) {
    ...
    const width = (vbWidth / vbHeight) * size;
...
export function Splunk(props) {
    return (
        <SVG screenReaderText={_('Splunk')} viewBox="0 0 243 72" appearance="corporate" {...props} >
            {splunkPath}
            {greaterPath}
        </SVG>
    );
...
export function Enterprise(props) {
    return (
        <SVG screenReaderText={_('Splunk Enterprise')} viewBox="0 0 561 72" appearance="enterprise" {...props} >
            {splunkPath}
            {greaterPath}
...
export function Hunk(props) {
    return (
        <SVG screenReaderText={_('Hunk')} viewBox="0 0 249 72" appearance="enterprise" {...props} >
            ...
            <path data-color="brand" d="M198.47 67.313h-.898v-.464h2.3v.463h-.897v2.375h-.504v-2.375M200.397 66.85h.53l.866 1.343.863-1.344h.53v2.838h-.498v-2.036l-.895 1.338h-.02l-.886-1.33v2.028h-.49v-2.84" />
...
export function Light(props) {
    return (
        <SVG screenReaderText={_('Splunk Light')} viewBox="0 0 386 72" appearance="light" {...props} >
            {splunkPath}
            {greaterPath}
...
export function Cloud(props) {
    return (
        <SVG screenReaderText={_('Splunk Cloud')} viewBox="0 0 431 72" appearance="enterprise" {...props} >
            {splunkPath}
            {greaterPath}

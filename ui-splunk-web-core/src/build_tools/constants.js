...
var webCore = path.join(__dirname, 'src');
var build_tools = path.join(webCore, 'build_tools');
...
var profilesDir = path.join(build_tools, 'profiles');
var standaloneProfilesDir = path.join(profilesDir, 'standalone');
var jsDir = path.join(webCore, 'js');

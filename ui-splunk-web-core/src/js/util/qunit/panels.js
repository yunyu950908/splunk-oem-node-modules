    ...
    function(
        ...
        return {
            ...
            createTestPanelsCollection: function(){
                ...
                this.appLocalsUnfilteredAllCollection = new AppCollection();
                this.appLocalsUnfilteredAllCollection.parse({
                    data: appLocalData.APP_LOCAL
                });
            ...
            setupTestPanelsView: function(product){
                ...
                this.view = new PageController({
                    ...
                    collection: {
                        ...
                        appLocalsUnfilteredAll: this.appLocalsUnfilteredAllCollection,

    ...
    function(
        ...
        return {
            ...
            testControllerSetup: function(view) {
                ...
                assert.equal(Object.keys(view.collection).length, 13, "There should be 13 items in the collection.");
                ...
                assert.equal(Object.keys(view.collection)[5], "externalVisualizations", "This item in the collection should be externalVisualizations.");
                ...
                assert.equal(Object.keys(view.collection)[9], "rolesCollection", "This item in the collection should be rolesCollection.");
                assert.equal(Object.keys(view.collection)[10], "usersSearch", "This item in the collection should be usersSearch.");
                assert.equal(Object.keys(view.collection)[11], "flashMessages", "This item in the collection should be flashMessages.");
                assert.equal(Object.keys(view.collection)[12], "entities", "This item in the collection should be entities.");

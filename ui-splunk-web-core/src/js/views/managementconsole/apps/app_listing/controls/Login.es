...
export default LoginView.extend({
    ...
    initialize(options) {
        ...
        this.splunkBaseLink = this.model.app.getRemotePath();
        this.licenseName = this.model.app.getLicenseName();
        this.licenseURL = this.model.app.getLicenseUrl();
    },
    ...
    doLogin() {
        this.model.auth.save({
            ...
            error: (model) => {
                model.trigger('loginFail');
            },
            success: (model) => {
                model.trigger('loginComplete');
            },
        });
    },

    ...
    return Modal.extend({
            ...
            */
            ...
            transposeFromUI: function() {
                ...
                if (!this.model.inmem.entry.content.get('action.lookup')) {
                    this.model.inmem.entry.content.set({
                        'action.lookup.filename': this.model.report.entry.content.get('action.lookup.filename'),
                        'action.lookup.append': this.model.report.entry.content.get('action.lookup.append')
                    });
                }

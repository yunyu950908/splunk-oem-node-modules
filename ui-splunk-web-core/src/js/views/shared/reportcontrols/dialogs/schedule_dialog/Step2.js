define(
        [
            ...
            'views/shared/reportcontrols/dialogs/schedule_dialog/LookupControls',
            'splunk.util',
            'uri/route',
            'util/console',
            'util/pdf_utils'
        ...
        return Base.extend({
            ...
            initialize: function() {
                ...
                var emailHelpText = _('Email must be configured in Server&nbsp;Settings > Email&nbsp;Settings. %s').t();
                ...
                this.children.lookupControls = new LookupControls({
                    model: {
            ...
            render: function() {
                $.when(this.deferredPdfAvailable).then(function() {
                    ...
                    this.children.lookupControls.render().appendTo(this.$(Modal.BODY_FORM_SELECTOR));

define(
    ...
    function($, _, module, Ace, Base, AutoCompletion, keyboard_utils, Printer, userAgent) {
        return Base.extend({
            moduleId: module.id,
            ...
            /**
             * Calls the reformatSearch function on the editor when available, otherwise waits for 
             * the spl mode to be set on the ace module before calling the reformatSearch function 
             * on the editor.
             */
            reformatSearch: function() {
                ...
                if (_.isFunction(this.editor.reformatSearch)) {
                    this.editor.reformatSearch();
                } else {
                    this.editor.session.once('changeMode', function(e) {
                        _.isFunction(this.editor.reformatSearch) && this.editor.reformatSearch();
                    }.bind(this));
                }
            },
            ...
            render: function() {
                if (!this.$el.html()) {
                    ...
                    this.editor.setOptions({
                        ...
                        theme: 'ace/theme/spl-' + this.options.syntaxHighlighting,

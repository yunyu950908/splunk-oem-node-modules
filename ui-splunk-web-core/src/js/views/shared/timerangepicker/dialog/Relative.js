        ...
        return Base.extend({
            ...
            startListening: function() {
                ...
                this.listenTo(this.model.earliestTimeParser, "error", function() {
                    ...
                    this.model.earliestTimeParser.unset(this.model.earliestTimeParser.idAttribute, {silent: true});
                    this.disableApply();
                });
                ...
                this.listenTo(this.model.latestTimeParser, "error", function() {
                    ...
                    this.model.latestTimeParser.unset(this.model.latestTimeParser.idAttribute, {silent: true});
                    this.disableApply();
                });
